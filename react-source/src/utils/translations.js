export const translations = {
  ko: {
    ...
    education: {
      ...
      syllabus: '강의계획서',
      syllabusTitle: '강의계획서',
      syllabusSubtitle: '교육 강의계획서를 확인하세요',
      catGenAi: 'Gen AI활용',
      catAutomation: '업무자동화',
      catCertificate: '자격증강의',
      catCorporate: '기업 맞춤강의',
      catProgramming: '프로그래밍 강의',
      catUniversity: '대학 강의',
      catEtc: '기타',
      statusActive: '운영',
      statusInactive: '미운영',
    ...
    publishing: {
      ...
      bookTitle: '도서 & 교육교재',
      bookDesc: 'IT 전문 서적 및 교육교재 기획·출판',
    ...
    community: {
      ...
      blogTitle: '블로그',
      blogSubtitle: 'IT 트렌드, 기술 소식, 그리고 드림아이티비즈의 이야기를 공유합니다',
      galleryTitle: '갤러리',
      gallerySubtitle: '드림아이티비즈의 프로젝트, 행사, 교육 현장을 사진으로 만나보세요',
      all: '전체',
      notice: '공지사항',
      free: '자유게시판',
      qna: 'Q&A',
    ...
    homeServices: {
      ...
      design: { title: '디자인 & 디지털콘텐츠', desc: '브랜드 디자인부터 영상·SNS 콘텐츠까지', f1: '브랜드 디자인', f2: 'UI/UX 디자인', f3: '디지털 콘텐츠' },
    ...
    auth: {
      ...
      editProduct: '상품 수정',
      productTitle: '상품명',
      productTitleEn: '상품명 (영문)',
      productDesc: '상품 설명',
      productDescEn: '상품 설명 (영문)',
      productPrice: '가격',
  ...
  en: {
    ...
    education: {
      ...
      syllabusSubtitle: 'View education syllabi',
      catGenAi: 'Gen AI',
      catAutomation: 'Automation',
      catCertificate: 'Certification',
      catCorporate: 'Corporate Training',
    ...
    publishing: {
      ...
      bookTitle: 'Books & Education Materials',
      bookDesc: 'IT books and educational materials publishing',
    ...
    community: {
      ...
      blogTitle: 'Blog',
      blogSubtitle: 'IT trends, tech news, and stories from DreamIT Biz',
      galleryTitle: 'Gallery',
      gallerySubtitle: 'Explore DreamIT Biz projects, events, and training through photos',
      all: 'All',
      notice: 'Notice',
      free: 'General',
      qna: 'Q&A',
      ...
      editPost: 'Edit Post',
      readMore: 'Read More',
      galleryProject: 'Projects',
      galleryOffice: 'Office',
      galleryEvent: 'Events',
      galleryEducation: 'Education',
      prev: 'Previous',
      next: 'Next'
    },
    portfolio: {
    ...
    homeServices: {
      ...
      design: { title: 'Design & Digital Content', desc: 'From brand design to video & SNS content', f1: 'Brand Design', f2: 'UI/UX Design', f3: 'Digital Content' },
    ...
    auth: {
      ...
      productTitleEn: 'Product Title (EN)',
      productDesc: 'Description',
      productDescEn: 'Description (EN)',
      productPrice: 'Price',
      productCategory: 'Category',
      productSlug: 'Product Code',
