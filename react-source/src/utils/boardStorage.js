/**
 * boardStorage.js
 * 게시판/블로그/갤러리 CRUD (localStorage 폴백 + Supabase 대응)
 */

const STORAGE_KEYS = {
  board: 'dreamitbiz_board_posts',
  blog: 'dreamitbiz_blog_posts',
  gallery: 'dreamitbiz_gallery_items',
  initialized: 'dreamitbiz_data_initialized'
};
...
const seedBoardPosts = [
  {
    id: 1,
    category: 'free',
    title: '맞춤 강의 후기 - Python 데이터 분석 과정',
    content: '드림아이티비즈에서 진행한 Python 데이터 분석 과정을 수강했습니다.\n\n강의 내용이 실무 중심으로 구성되어 있어서 바로 업무에 적용할 수 있었습니다.\n특히 Pandas와 Matplotlib을 활용한 데이터 시각화 부분이 매우 유익했습니다.\n\n강사님께서 현업 경험을 바탕으로 설명해주셔서 이해가 잘 되었고,\n실습 위주의 수업 방식이 좋았습니다.\n\n다음에는 머신러닝 과정도 수강하고 싶습니다. 추천합니다!',
    author: '박수강',
    date: '2026-02-10',
    views: 31,
  ...
  },
  {
    id: 2,
    category: 'qna',
    title: '웹호스팅 SSL 인증서 설정 관련 질문',
    content: '안녕하세요.\n\n드림아이티비즈 웹호스팅 서비스를 이용 중인데요,\nSSL 인증서 설정 관련해서 질문이 있습니다.\n\nLet\'s Encrypt 무료 인증서를 적용하려고 하는데,\n호스팅 관리자 패널에서 어떻게 설정하면 되나요?\n\n기존에 HTTP로 접속되던 사이트를 HTTPS로 전환하고 싶습니다.\n리다이렉트 설정도 같이 안내해주시면 감사하겠습니다.',
    author: '이호스팅',
    date: '2026-02-12',
    views: 18,
  ...
  },
  {
    ...
    content: 'React 19의 주요 새로운 기능을 정리해봤습니다.\n\n1. React Compiler\n- 자동 메모이제이션으로 useMemo, useCallback 불필요\n- 빌드 타임에 최적화 코드 생성\n\n2. Actions\n- 폼 처리를 위한 새로운 패턴\n- useActionState로 상태 관리\n\n3. use() API\n- Promise와 Context를 직접 읽을 수 있는 새 API\n- Suspense와 자연스럽게 통합\n\n4. Server Components 안정화\n- 서버에서 렌더링되는 컴포넌트 정식 지원\n\n5. Document Metadata\n- <title>, <meta> 등을 컴포넌트에서 직접 관리\n\n자세한 내용은 React 공식 블로그를 참고해주세요!',
    author: '김개발',
    date: '2026-02-14',
    views: 25,
  ...
  },
  {
    ...
    content: '안녕하세요, 드림아이티비즈입니다.\n\n2026년 상반기 교육 일정을 안내드립니다.\n\n[3월]\n- Python 기초 과정 (3/3 ~ 3/14)\n- 웹 프론트엔드 부트캠프 (3/10 ~ 3/28)\n\n[4월]\n- React 실무 과정 (4/7 ~ 4/18)\n- 데이터베이스 설계 (4/14 ~ 4/25)\n\n[5월]\n- AI/머신러닝 입문 (5/12 ~ 5/23)\n- 클라우드 인프라 구축 (5/19 ~ 5/30)\n\n[6월]\n- 풀스택 개발 종합 (6/2 ~ 6/27)\n\n각 과정은 기업 맞춤으로 진행되며,\n상세 커리큘럼은 문의를 통해 확인하실 수 있습니다.\n\n감사합니다.',
    author: '관리자',
    date: '2026-02-15',
    views: 38,
  ...
  },
  {
    id: 5,
    category: 'notice',
    title: '드림아이티비즈 커뮤니티 게시판 오픈 안내',
    content: '안녕하세요, 드림아이티비즈입니다.\n\n커뮤니티 게시판이 새롭게 오픈되었습니다!\n\n[게시판 카테고리]\n- 공지사항: 드림아이티비즈의 주요 소식과 안내\n- 자유게시판: IT 관련 정보 공유 및 자유로운 의견 교환\n- Q&A: 서비스 이용 관련 질문과 답변\n\n많은 참여 부탁드립니다.\n건전한 커뮤니티 문화를 함께 만들어가겠습니다.\n\n감사합니다.',
    author: '관리자',
    date: '2026-02-18',
    views: 42,
...
const seedBlogPosts = [
  {
    ...
    titleEn: 'Effective Corporate IT Training Design Methodology',
    excerpt: '기업 맞춤 IT 교육의 효과를 극대화하는 커리큘럼 설계 방법론을 소개합니다.',
    excerptEn: 'Introducing curriculum design methodologies that maximize the effectiveness of corporate IT training.',
  ...
  },
  {
    ...
    titleEn: 'SME Digital Transformation Success Stories',
    excerpt: '드림아이티비즈가 함께한 중소기업 디지털 전환 성공 사례를 공유합니다.',
    excerptEn: 'Sharing digital transformation success stories with DreamIT Biz.',
  ...
  },
  {
    ...
    titleEn: 'Advantages of Cloud-Native Hosting',
    excerpt: '클라우드 네이티브 호스팅이 기존 호스팅 대비 어떤 이점을 제공하는지 비교 분석합니다.',
    excerptEn: 'Comparing cloud-native hosting advantages over traditional hosting.',
  ...
  },
  {
    ...
    titleEn: 'UI/UX Design Trends 2026',
    excerpt: '미니멀리즘에서 뉴모피즘까지, 2026년 주목해야 할 UI/UX 디자인 트렌드를 소개합니다.',
    excerptEn: 'From minimalism to neumorphism, introducing UI/UX design trends to watch in 2026.',
  ...
  },
  {
    ...
    titleEn: 'React 19 New Features and Migration Guide',
    excerpt: 'React 19의 주요 변경사항과 기존 프로젝트를 안전하게 마이그레이션하는 방법을 알아봅니다.',
    excerptEn: 'Learn about major changes in React 19 and how to safely migrate existing projects.',
  ...
  },
  {
    ...
    titleEn: '2026 Web Development Trends: Development with AI',
    excerpt: '2026년 웹 개발의 핵심 트렌드는 AI 기반 코드 생성, 서버리스 아키텍처, 그리고 WebAssembly의 확산입니다.',
    excerptEn: 'Key 2026 web development trends include AI-based code generation, serverless architecture, and WebAssembly.',
...
const seedGalleryItems = [
  {
    id: 1,
    title: '세종대 미래교육원 웹사이트',
    titleEn: 'Sejong Univ. Future Education Center Website',
    category: 'project',
    imageUrl: '',
    description: '세종대학교 미래교육원 공식 웹사이트 개발 프로젝트',
    descriptionEn: 'Sejong University Future Education Center official website development',
    date: '2025-06-15',
    created_at: '2025-06-15T09:00:00Z'
  },
  {
    id: 2,
    title: '진주교대 100주년 기념 사이트',
    titleEn: 'Jinju National Univ. of Education 100th Anniversary',
    category: 'project',
    imageUrl: '',
    description: '진주교육대학교 100주년 기념 특별 웹사이트',
    descriptionEn: 'Jinju National University of Education 100th anniversary special website',
    date: '2025-08-20',
  ...
  },
  {
    id: 3,
    title: '드림아이티비즈 워크숍',
    titleEn: 'DreamIT Biz Workshop',
    category: 'education',
    imageUrl: '',
    description: '2025 하반기 기업 맞춤 교육 워크숍 현장',
    descriptionEn: '2025 H2 Corporate custom training workshop',
    date: '2025-10-10',
  ...
  },
  {
    id: 4,
    title: '사무실 전경',
    titleEn: 'Office Overview',
    category: 'office',
    imageUrl: '',
    description: '드림아이티비즈 본사 사무실',
    descriptionEn: 'DreamIT Biz headquarters office',
    date: '2025-11-01',
  ...
  },
  {
    ...
    descriptionEn: '2025 year-end party and awards ceremony',
    date: '2025-12-22',
    created_at: '2025-12-22T09:00:00Z'
  },
  {
    id: 6,
    title: 'Python 데이터 분석 교육',
    titleEn: 'Python Data Analysis Training',
    category: 'education',
    imageUrl: '',
    description: 'Python 데이터 분석 실무 교육 과정',
    descriptionEn: 'Python data analysis practical training course',
    date: '2026-01-15',
    created_at: '2026-01-15T09:00:00Z'
  },
  {
    id: 7,
    title: 'E-커머스 플랫폼 리뉴얼',
    titleEn: 'E-Commerce Platform Renewal',
    category: 'project',
    imageUrl: '',
    description: '중소기업 쇼핑몰 전면 리뉴얼 프로젝트',
    descriptionEn: 'SME shopping mall full renewal project',
    date: '2026-01-20',
    created_at: '2026-01-20T09:00:00Z'
  },
  {
    id: 8,
    title: '2026 신년 킥오프 미팅',
    titleEn: '2026 New Year Kickoff Meeting',
    category: 'event',
    imageUrl: '',
    description: '2026년 신년 전략 회의 및 킥오프 미팅',
    descriptionEn: '2026 new year strategy meeting and kickoff',
    date: '2026-01-06',
...
function ensureInitialized() {
  ...
  if (!getStore(STORAGE_KEYS.board)) setStore(STORAGE_KEYS.board, seedBoardPosts);
  if (!getStore(STORAGE_KEYS.blog)) setStore(STORAGE_KEYS.blog, seedBlogPosts);
  if (!getStore(STORAGE_KEYS.gallery)) setStore(STORAGE_KEYS.gallery, seedGalleryItems);
...
export function getBoardPosts() {
  ensureInitialized();
  return getStore(STORAGE_KEYS.board) || [];
}

export function getBoardPost(id) {
...
export function createBoardPost({ category, title, content, author }) {
  ...
  setStore(STORAGE_KEYS.board, [...posts, newPost]);
  return newPost;
}

export function updateBoardPost(id, updates) {
  const posts = getBoardPosts();
  const idx = posts.findIndex((p) => p.id === Number(id));
  if (idx === -1) return null;
  posts[idx] = { ...posts[idx], ...updates, updated_at: new Date().toISOString() };
  setStore(STORAGE_KEYS.board, posts);
  return posts[idx];
}

export function deleteBoardPost(id) {
  const posts = getBoardPosts();
  const filtered = posts.filter((p) => p.id !== Number(id));
  setStore(STORAGE_KEYS.board, filtered);
  return filtered.length < posts.length;
}

export function incrementBoardViews(id) {
  const posts = getBoardPosts();
  const idx = posts.findIndex((p) => p.id === Number(id));
  if (idx === -1) return;
...
export function getBlogPosts() {
  ensureInitialized();
  return getStore(STORAGE_KEYS.blog) || [];
}
...
export function getGalleryItems() {
  ensureInitialized();
  return getStore(STORAGE_KEYS.gallery) || [];
}
