...
const siteGroups = [
...

  {
    ...
    sites: [
      { name: 'cnu', url: 'https://cnu.dreamitbiz.com', emoji: '🏭', ko: '전남대학교 생성형 AI 교육 — 전남대학교 대상 생성형 AI 활용 교육 학습 플랫폼', en: 'CNU AI Education — client-commissioned education program' },
      { name: 'contents', url: 'https://contents.dreamitbiz.com', emoji: '🏭', ko: '휴넷 인재키움 AI 홍보 실무 — 「AI로 만드는 홍보 실무」 8시간 워크숍 — 도장깨기 미션·갤러리', en: 'Hunet AI Workshop — client-commissioned education program' },
      { name: 'dasco', url: 'https://dasco.dreamitbiz.com', emoji: '🏭', ko: '다스코 생성형AI 교육 — 다스코(주) 직원을 위한 생성형 AI 업무 활용 교육', en: 'DASCO AI Academy — client-commissioned education program' },
      { name: 'data', url: 'https://data.dreamitbiz.com', emoji: '🏭', ko: 'KERIS 데이터 분석 실습 — 엑셀 EDA·시각화 대시보드 — 1일 6시간 실습 과정', en: 'KERIS Data Lab — client-commissioned education program' },
      { name: 'halla', url: 'https://halla.dreamitbiz.com', emoji: '🎓', ko: '한라대학교 하계 방학특강 — 2026 하계 특강 — AI기초·바이브코딩·생성형AI 3개 과정', en: 'Halla Summer AI — customized university/instructor program' },
      { name: 'kdn2026', url: 'https://kdn2026.dreamitbiz.com', emoji: '🏭', ko: '한전KDN 바이브코딩 — KDN 직원 대상 바이브코딩을 활용한 풀스택 웹 개발 교육 (3일, 21시간)', en: 'KDN Vibe Coding — client-commissioned education program' },
      { name: 'knc', url: 'https://knc.dreamitbiz.com', emoji: '🏭', ko: '산업안전 성과 대시보드 — 50개 기업 통합 사회비용 절감액 관리 대시보드', en: 'KNC Dashboard — client-commissioned education program' },
      { name: 'komipo', url: 'https://komipo.dreamitbiz.com', emoji: '🏭', ko: '한국중부발전 AI 아카데미 — 한국중부발전 전 직원 대상 AI 리터러시 교육', en: 'KOMIPO AI Academy — client-commissioned education program' },
      { name: 'koreait', url: 'https://koreait.dreamitbiz.com', emoji: '🏭', ko: '코리아IT아카데미 — 직업능력개발훈련 대시보드 (기관경영, 훈련과정, 인프라)', en: 'KoreaIT — client-commissioned education program' },
      { name: 'pbi', url: 'https://pbi.dreamitbiz.com', emoji: '🏭', ko: 'PBI 로봇 교육센터 — 키즈~성인~기업 맞춤 로봇 교육, 과정 안내·강사·FAQ', en: 'PBI — client-commissioned education program' },
      { name: 'pbirobot', url: 'https://pbirobot.dreamitbiz.com', emoji: '🏭', ko: 'PBI Robot 제품 — AI 기반 로봇 수영장 청소기 AquaSense 시리즈', en: 'PBI Robot — client-commissioned education program' },
      { name: 'seoultech', url: 'https://seoultech.dreamitbiz.com', emoji: '🎓', ko: '서울과학기술대학교 생성형AI 강의 — 서울과학기술대학교 전체 교수 대상 생성형 AI 활용 강의', en: 'SeoulTech AI Lecture — customized university/instructor program' },
      { name: 'skala', url: 'https://skala.dreamitbiz.com', emoji: '🏭', ko: 'SKALA 4기 커리큘럼 — SK AI Leader Academy 4기 커리큘럼 뷰어 (2026.7~12)', en: 'SKALA Curriculum — client-commissioned education program' },
      { name: 'snu', url: 'https://snu.dreamitbiz.com', emoji: '🎓', ko: '서울대학교 하계 계절학기 — PBL LMS — 제주 생태포럼 해커톤 연계 15차시 과정', en: 'SNU Summer PBL — customized university/instructor program' },
      { name: 'syu', url: 'https://syu.dreamitbiz.com', emoji: '🎓', ko: '삼육대학교 생성형 AI 특강 — 생성형 AI 실무 역량 강화 특강 — 과정별 학습자료·로그인 (9/14·15·21·22)', en: 'Sahmyook AI Lecture — customized university/instructor program' },
      { name: 'university', url: 'https://university.dreamitbiz.com', emoji: '🎓', ko: '생성형 AI 실무 자동화 — 전남대학교 직원·조교 대상 AI 실무 자동화 교육', en: 'University AI — customized university/instructor program' },
    ],
  },
  {
    ...
    sites: [
      { name: 'ai-free', url: 'https://ai-free.dreamitbiz.com', emoji: '🤖', ko: '무료 AI 활용 학습 — 무료로 시작하는 생성형 AI 학습 — 입문자 대상 무료 강의 플랫폼', en: 'AI Free Academy — AI utilization & hands-on learning' },
      { name: 'ax-study', url: 'https://ax-study.dreamitbiz.com', emoji: '🤖', ko: 'AX 재직자 80시간 과정 — 데이터 분석, RAG 생성형 AI, Agentic AI, 실전 Mini PJT — 재직자 10일 LMS', en: 'AX Study — AI utilization & hands-on learning' },
      { name: 'ax', url: 'https://ax.dreamitbiz.com', emoji: '🤖', ko: 'AX & DX 학습 — AI 전환(AX)과 디지털 전환(DX), 최신 트렌드 종합 학습', en: 'AX & DX — AI utilization & hands-on learning' },
      { name: 'basic-ai', url: 'https://basic-ai.dreamitbiz.com', emoji: '🤖', ko: '인공지능 기초 학습 — AI 기초, 활용, 윤리, 트렌드, AX, 용어사전까지 학습', en: 'Basic AI — AI utilization & hands-on learning' },
      { name: 'codex', url: 'https://codex.dreamitbiz.com', emoji: '🤖', ko: '코덱스 CLI 마스터 — OpenAI Codex CLI 완전 정복 — 설치부터 고급 프로젝트까지', en: 'Codex CLI Master — AI utilization & hands-on learning' },
      { name: 'copilot', url: 'https://copilot.dreamitbiz.com', emoji: '🤖', ko: 'Microsoft Copilot — MS Copilot 사용법, Office 연동, 코딩 보조', en: 'Copilot — AI utilization & hands-on learning' },
      { name: 'harness-study', url: 'https://harness-study.dreamitbiz.com', emoji: '🤖', ko: '하네스 마스터 — Harness 에이전트 오케스트레이션 — 팀 설계부터 실전', en: 'Harness Master — AI utilization & hands-on learning' },
      { name: 'manus', url: 'https://manus.dreamitbiz.com', emoji: '🤖', ko: 'Manus AI 학습 플랫폼 — Manus AI — 세계 최초 자율형 AI 에이전트 플랫폼 종합 학습', en: 'Manus AI Master — AI utilization & hands-on learning' },
      { name: 'notebooklm', url: 'https://notebooklm.dreamitbiz.com', emoji: '🤖', ko: 'NotebookLM 학습 센터 — Google NotebookLM 교육 과정 — 기초부터 사업계획서 작성까지', en: 'NotebookLM — AI utilization & hands-on learning' },
      { name: 'solar', url: 'https://solar.dreamitbiz.com', emoji: '🤖', ko: 'Solar LLM 학습 — 국산 LLM Solar 기반 AI 서비스 개발 실무 교육', en: 'Solar AI — AI utilization & hands-on learning' },
      { name: 'startup', url: 'https://startup.dreamitbiz.com', emoji: '🤖', ko: '생성형 AI 창업 교육 — 생성형 AI를 활용한 비즈니스 기획 및 성장 전략 교육', en: 'AI Startup Academy — AI utilization & hands-on learning' },
    ],
  },
  {
    ...
    sites: [
      { name: 'aice', url: 'https://aice.dreamitbiz.com', emoji: '📜', ko: 'AICE Associate 학습 — AICE Associate 자격증 시험 대비 학습 플랫폼', en: 'AICE Associate — certification exam preparation' },
      { name: 'aisw', url: 'https://aisw.dreamitbiz.com', emoji: '💻', ko: 'AI·SW 개론 — SW·DS·AIoT·AI·XR·HMI 분야 탐색, 한신대학교 교과목', en: 'AI·SW 개론 — computer science learning' },
      { name: 'aws', url: 'https://aws.dreamitbiz.com', emoji: '📜', ko: 'AWS 자격증 — AWS 클라우드 자격증 시험 대비 학습 플랫폼', en: 'AWS — certification exam preparation' },
      { name: 'project', url: 'https://project.dreamitbiz.com', emoji: '⌨️', ko: '프로젝트 기술 학습 플랫폼 — 웹·로컬앱·AI·DevOps — 프로젝트 실행 기술을 한 자리에서 학습', en: 'DevLab — programming learning' },
      { name: 'web', url: 'https://web.dreamitbiz.com', emoji: '⌨️', ko: '웹 개발 학습 — 웹 개발 기초부터 실전까지 종합 학습 플랫폼', en: 'Web Development — programming learning' },
    ],
  },
  {
    ...
    sites: [
      { name: 'accounting', url: 'https://accounting.dreamitbiz.com', emoji: '💼', ko: '회계 & 재무 가이드 — 회계 기초, 재무제표, 원가/관리회계, 세무, 감사', en: 'Accounting — business major learning' },
      { name: 'aebon', url: 'https://aebon.dreamitbiz.com', emoji: '🎯', ko: '이애본 — Ph.D 이애본 개인 포트폴리오·소개 사이트', en: 'Aebon — career & job preparation' },
      { name: 'ai-literacy', url: 'https://ai-literacy.dreamitbiz.com', emoji: '📚', ko: 'AI 리터러시 — AI 시대 필수 교양 — AI 기초, 활용, 윤리, 미래 학습', en: 'AI Literacy — liberal arts learning' },
      { name: 'coding-hub', url: 'https://coding-hub.dreamitbiz.com', emoji: '🔗', ko: '코딩 학습 허브 — HTML, React, Python, Java, C 등 7개 플랫폼', en: 'Coding Hub — integrated learning hub' },
      { name: 'esg', url: 'https://esg.dreamitbiz.com', emoji: '📚', ko: 'ESG & CSR 가이드 — ESG, CSR, 사회적 경제를 종합 학습하는 가이드', en: 'ESG — liberal arts learning' },
      { name: 'full-stack', url: 'https://full-stack.dreamitbiz.com', emoji: '🧩', ko: '풀스택 학습 — 프론트엔드~백엔드~DevOps 풀스택 개발 학습', en: 'Full-Stack — learning platform' },
      { name: 'hohai', url: 'https://hohai.dreamitbiz.com', emoji: '🎯', ko: '호하이 — 개인 포트폴리오 사이트', en: 'Hohai — career & job preparation' },
      { name: 'hrm', url: 'https://hrm.dreamitbiz.com', emoji: '💼', ko: '인적자원관리 — 채용, 교육, 성과관리, 보상, 노사관계, 조직문화', en: 'HRM — business major learning' },
      { name: 'hwp', url: 'https://hwp.dreamitbiz.com', emoji: '🧩', ko: '한글 문서 변환기 — HWP/HWPX 문서를 웹에서 변환·편집·관리하는 도구', en: 'HWP Web — learning platform' },
      { name: 'jdy', url: 'https://jdy.dreamitbiz.com', emoji: '🎯', ko: '정동엽 — 정동엽 개인 포트폴리오·소개 사이트', en: 'JDY — career & job preparation' },
      { name: 'jobexam', url: 'https://jobexam.dreamitbiz.com', emoji: '🧩', ko: '직업상담사 시험 준비 — 직업상담사 1급·2급 필기·실기 CBT 학습 플랫폼', en: 'JobExam — learning platform' },
      { name: 'ppt-maker', url: 'https://ppt-maker.dreamitbiz.com', emoji: '🧩', ko: 'AI 프레젠테이션 제작 도구 — AI 프레젠테이션 생성 SaaS — 멀티 프로바이더 + 크레딧 결제 (ppt/GenPPT 후속)', en: 'PPT Maker — learning platform' },
      { name: 'ppt', url: 'https://ppt.dreamitbiz.com', emoji: '🧩', ko: 'AI 프레젠테이션 생성기 — AI 기반 프레젠테이션 자동 생성 — OpenAI/Claude 활용 슬라이드 제작', en: 'GenPPT — learning platform' },
      { name: 'research', url: 'https://research.dreamitbiz.com', emoji: '💼', ko: '사회과학 조사방법론 — 연구설계, 표본추출, 측정, 설문, 실험, 질적연구', en: 'Research — business major learning' },
      { name: 'rest', url: 'https://rest.dreamitbiz.com', emoji: '🏢', ko: '쉬었음청년 AI교육 — AI·바이브코딩 교육, AI 리부트 경진대회, LMS, 코칭', en: 'AI Reboot Academy — DreamIT Biz official service' },
      { name: 'rest01', url: 'https://rest01.dreamitbiz.com', emoji: '🎯', ko: '이력서 웹사이트 예시 — AI Reboot Academy 교보재 — 정적 HTML 이력서 사이트 예시', en: 'Resume Sample — career & job preparation' },
      { name: 'rest02', url: 'https://rest02.dreamitbiz.com', emoji: '🎯', ko: 'IT 솔루션 회사 사이트 템플릿 — AI Reboot Academy 교보재 — IT 솔루션·소프트웨어·웹개발 회사 사이트 예제', en: 'DreamIT Solution Template — career & job preparation' },
      { name: 'rest03', url: 'https://rest03.dreamitbiz.com', emoji: '🎯', ko: 'CHINHUNG 회사 사이트 템플릿 — AI Reboot Academy 교보재 — 회사 소개 사이트 템플릿', en: 'CHINHUNG Template — career & job preparation' },
      { name: 'rest04', url: 'https://rest04.dreamitbiz.com', emoji: '🎯', ko: 'AICADEMY 동영상 교육 템플릿 — AI Reboot Academy 교보재 — 온라인 AI 동영상 교육 템플릿', en: 'AICADEMY Template — career & job preparation' },
      { name: 'rest05', url: 'https://rest05.dreamitbiz.com', emoji: '🏢', ko: '드림아이티비즈 인재풀 — 인재홍보(역채용) 쇼케이스 — 인증점수 5축 + OpenAI 취업코칭 챗봇', en: 'DreamIT Talent Pool — DreamIT Biz official service' },
      { name: 'rest06', url: 'https://rest06.dreamitbiz.com', emoji: '🏢', ko: '드림아이티비즈 IT 교육 플랫폼 — 온라인 IT 교육·코딩·자격증·데이터 AI — 구글·카카오 로그인 + 아임포트 결제', en: 'DreamIT IT Education — DreamIT Biz official service' },
      { name: 'rest07', url: 'https://rest07.dreamitbiz.com', emoji: '🧩', ko: '토닥케어 반려동물 케어 랜딩 — 반려동물 케어 랜딩 React 템플릿 — dc-runtime 아티팩트를 9페이지 SPA로 이식', en: 'TodakCare — learning platform' },
      { name: 'safety', url: 'https://safety.dreamitbiz.com', emoji: '📚', ko: '안전보건관리 — 산업안전, 보건관리, 위험성평가, 안전교육', en: 'Safety — liberal arts learning' },
      { name: 'sangmin', url: 'https://sangmin.dreamitbiz.com', emoji: '🎯', ko: '박상민 — 박상민 개인 포트폴리오 사이트', en: 'Sangmin — career & job preparation' },
      { name: 'seminar', url: 'https://seminar.dreamitbiz.com', emoji: '🏢', ko: '드림아이티 세미나 — 프리미엄 세미나 플랫폼 — 벤토 그리드 홈, 관리자 승인 워크플로우', en: 'DreamIT Seminar — DreamIT Biz official service' },
      { name: 'site', url: 'https://site.dreamitbiz.com', emoji: '🏢', ko: 'DreamIT 전체 사이트 포탈 — 전체 사이트 목록 및 카테고리별 분류 포탈', en: 'DreamIT Sites — DreamIT Biz official service' },
      { name: 'statistics', url: 'https://statistics.dreamitbiz.com', emoji: '📚', ko: '통계학 — 통계학의 모든 것을 배우는 종합 학습 플랫폼', en: 'Statistics — liberal arts learning' },
      { name: 'study', url: 'https://study.dreamitbiz.com', emoji: '📚', ko: '공부 잘하는 방법 — 효과적인 학습 노하우를 배우는 종합 학습 플랫폼', en: 'Study — liberal arts learning' },
      { name: 'survey', url: 'https://survey.dreamitbiz.com', emoji: '🎓', ko: '논문작성 가이드 — 논문작성의 전 과정을 체계적으로 배우는 학습 플랫폼', en: 'Survey — thesis & research learning' },
      { name: 'templete03', url: 'https://templete03.dreamitbiz.com', emoji: '🧩', ko: '러닝노트 학습사이트 템플릿 — 학습사이트 아트디렉션 재사용 베이스 — 다크 블루 5색·형광펜 시그니처', en: 'LearningNote Template — learning platform' },
      { name: 'thesis-hub', url: 'https://thesis-hub.dreamitbiz.com', emoji: '🔗', ko: '논문연구 학습 허브 — 연구방법론, 통계학, 조사방법론, AHP 등 5개 플랫폼', en: 'Thesis Hub — integrated learning hub' },
      { name: 'vibe-coding', url: 'https://vibe-coding.dreamitbiz.com', emoji: '🧩', ko: '바이브코딩 마스터 — AI 코딩 커리큘럼 + 실전 프로젝트 9개 + 28일 부트캠프', en: 'Vibe Coding Master — learning platform' },
      { name: 'vibe', url: 'https://vibe.dreamitbiz.com', emoji: '🧩', ko: '바이브코딩 학습 — VIBE CODING 학습 사이트 (vibe-coding과 별개 — 통합 여부 검토)', en: 'Vibe Coding — learning platform' },
      { name: 'wonjunjang', url: 'https://wonjunjang.dreamitbiz.com', emoji: '🎯', ko: '원준장 — 개인 포트폴리오 사이트', en: 'Wonjunjang — career & job preparation' },
      { name: 'www', url: 'https://www.dreamitbiz.com', emoji: '🏢', ko: '드림아이티비즈 메인 — 공식 홈페이지 — 회사소개, 서비스 안내, 전체 사이트 허브', en: 'DreamIT Biz — DreamIT Biz official service' },
    ],
  },
];
