...
const ALL_SITES: { name: string; domain: string; hasPayment: boolean }[] = [
  ...
  { name: 'career-hub', domain: 'career-hub.dreamitbiz.com', hasPayment: true },
  ...
  { name: 'ai-free', domain: 'ai-free.dreamitbiz.com', hasPayment: false },
  { name: 'ai-literacy', domain: 'ai-literacy.dreamitbiz.com', hasPayment: false },
  { name: 'aice', domain: 'aice.dreamitbiz.com', hasPayment: false },
  { name: 'ax-study', domain: 'ax-study.dreamitbiz.com', hasPayment: false },
  { name: 'ax', domain: 'ax.dreamitbiz.com', hasPayment: false },
  { name: 'basic-ai', domain: 'basic-ai.dreamitbiz.com', hasPayment: false },
  { name: 'cnu', domain: 'cnu.dreamitbiz.com', hasPayment: false },
  { name: 'codex', domain: 'codex.dreamitbiz.com', hasPayment: false },
  { name: 'contents', domain: 'contents.dreamitbiz.com', hasPayment: false },
  { name: 'dasco', domain: 'dasco.dreamitbiz.com', hasPayment: false },
  { name: 'data', domain: 'data.dreamitbiz.com', hasPayment: false },
  { name: 'full-stack', domain: 'full-stack.dreamitbiz.com', hasPayment: false },
  { name: 'halla', domain: 'halla.dreamitbiz.com', hasPayment: false },
  { name: 'harness-study', domain: 'harness-study.dreamitbiz.com', hasPayment: false },
  { name: 'hrm', domain: 'hrm.dreamitbiz.com', hasPayment: false },
  { name: 'hwp', domain: 'hwp.dreamitbiz.com', hasPayment: false },
  { name: 'kdn2026', domain: 'kdn2026.dreamitbiz.com', hasPayment: false },
  { name: 'knc', domain: 'knc.dreamitbiz.com', hasPayment: false },
  { name: 'komipo', domain: 'komipo.dreamitbiz.com', hasPayment: false },
  { name: 'manus', domain: 'manus.dreamitbiz.com', hasPayment: false },
  { name: 'notebooklm', domain: 'notebooklm.dreamitbiz.com', hasPayment: false },
  { name: 'ppt-maker', domain: 'ppt-maker.dreamitbiz.com', hasPayment: false },
  { name: 'ppt', domain: 'ppt.dreamitbiz.com', hasPayment: false },
  { name: 'project', domain: 'project.dreamitbiz.com', hasPayment: false },
  { name: 'research', domain: 'research.dreamitbiz.com', hasPayment: false },
  { name: 'rest', domain: 'rest.dreamitbiz.com', hasPayment: false },
  { name: 'rest01', domain: 'rest01.dreamitbiz.com', hasPayment: false },
  { name: 'rest02', domain: 'rest02.dreamitbiz.com', hasPayment: false },
  { name: 'rest03', domain: 'rest03.dreamitbiz.com', hasPayment: false },
  { name: 'rest04', domain: 'rest04.dreamitbiz.com', hasPayment: false },
  { name: 'rest05', domain: 'rest05.dreamitbiz.com', hasPayment: false },
  { name: 'rest06', domain: 'rest06.dreamitbiz.com', hasPayment: false },
  { name: 'rest07', domain: 'rest07.dreamitbiz.com', hasPayment: false },
  { name: 'sangmin', domain: 'sangmin.dreamitbiz.com', hasPayment: false },
  { name: 'seminar', domain: 'seminar.dreamitbiz.com', hasPayment: false },
  { name: 'seoultech', domain: 'seoultech.dreamitbiz.com', hasPayment: false },
  { name: 'site', domain: 'site.dreamitbiz.com', hasPayment: false },
  { name: 'skala', domain: 'skala.dreamitbiz.com', hasPayment: false },
  { name: 'snu', domain: 'snu.dreamitbiz.com', hasPayment: false },
  { name: 'solar', domain: 'solar.dreamitbiz.com', hasPayment: false },
  { name: 'startup', domain: 'startup.dreamitbiz.com', hasPayment: false },
  { name: 'syu', domain: 'syu.dreamitbiz.com', hasPayment: false },
  { name: 'templete03', domain: 'templete03.dreamitbiz.com', hasPayment: false },
  { name: 'university', domain: 'university.dreamitbiz.com', hasPayment: false },
  { name: 'vibe-coding', domain: 'vibe-coding.dreamitbiz.com', hasPayment: false },
  { name: 'web', domain: 'web.dreamitbiz.com', hasPayment: false },];
