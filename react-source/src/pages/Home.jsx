        ...
        <div className="container">
          ...
          <div className="services-grid">
            {[
              ...
              { path: '/services/education', icon: <><path d="M22 10v6M2 10l10-5 10 5-10 5z" /><path d="M6 12v5c3 3 9 3 12 0v-5" /></>, title: '기업 맞춤 강의', desc: '실무 중심의 IT 교육 프로그램', features: ['맞춤형 커리큘럼', '실습 중심 교육', '온/오프라인 강의'] },
              { path: '/services/publishing', icon: <><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20" /><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z" /></>, title: '출판사업', desc: 'IT 전문 서적 및 교육 콘텐츠 제작', features: ['IT 전문 서적', '교육 콘텐츠 제작', '전자책 제작'] }
            ].map((service, i) => (
